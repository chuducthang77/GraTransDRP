...
class GAT_GCN_Transformer_ge(torch.nn.Module):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2):

        super(GAT_GCN_Transformer_ge, self).__init__()
        ...
        self.fc1_xt_ge = nn.Linear(83584, output_dim)
